...
public class Prueba extends JFrame {
    ...
    public Prueba() {
        ...
        //Icono
        this.setIconImage(new ImageIcon(getClass().getResource("/com/iescomercio/eed/batallabarcos/resources/icono2.png")).getImage());
    ...
    private void botonEstablecerOpciones() {
        ...
        bb = new BatallaBarcos((int) this.jSpinnerNumTurnos.getValue(), (int) this.jSpinnerTamaño.getValue(), (int) this.jSpinnerNumBarcos.getValue());
